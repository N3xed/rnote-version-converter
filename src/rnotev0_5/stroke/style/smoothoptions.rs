...
impl From<crate::rnotev0_4::strokes::SmoothOptions> for SmoothOptions {
    fn from(so: crate::rnotev0_4::strokes::SmoothOptions) -> Self {
        let crate::rnotev0_4::strokes::SmoothOptions {
            seed: _,
            width,
            stroke_color,
            fill_color,
