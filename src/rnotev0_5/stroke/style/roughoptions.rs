...
pub use crate::rnotev0_4::roughoptions::FillStyle;

impl From<crate::rnotev0_4::roughoptions::RoughOptions> for RoughOptions {
    fn from(ro: crate::rnotev0_4::roughoptions::RoughOptions) -> Self {
        let crate::rnotev0_4::roughoptions::RoughOptions {
            max_randomness_offset: _,
            roughness,
            bowing,
            stroke_color,
            stroke_width,
            ...
            disable_multistroke,
            disable_multistroke_fill,
            preserve_vertices,
        } = ro;

        RoughOptions {
            max_randomness_offset: ro.max_randomness_offset,
            roughness,
            bowing,
            stroke_color,
            stroke_width,
